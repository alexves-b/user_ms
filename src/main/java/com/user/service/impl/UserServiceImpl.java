...
public class UserServiceImpl implements UserService {
    ...
    public AccountSecureDto createUser(AccountSecureDto accountSecureDto) {
        ...
        if (userRepository.findById(user.getId()).isPresent()) {
            AccountForFriends accountForFriends = objectMapper.convertValue(user, AccountForFriends.class);
            kafkaProducerForJson.sendMessageForFriends(accountForFriends);
        }
